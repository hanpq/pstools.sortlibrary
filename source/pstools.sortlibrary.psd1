...
@{
  ...
  FileList = @('.\data\appicon.ico','.\data\banner.ps1','.\docs\pstools.sortlibrary.md','.\include\module.utility.functions.ps1','.\private\.gitignore','.\public\Sort-UsingQuickSort.ps1','.\public\Test-SortingAlgorithms.ps1','.\settings\config.json','.\LICENSE.txt','.\pstools.sortlibrary.psd1','.\pstools.sortlibrary.psm1')
  PrivateData = @{
